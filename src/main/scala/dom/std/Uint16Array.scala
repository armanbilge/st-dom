...
trait Uint16Array
  ...
  /**
    ...
    * If thisArg is omitted, undefined is used as the this value.
    */
  def map(callbackfn: js.Function3[/* value */ Double, /* index */ Double, /* array */ this.type, Double]): Uint16Array = js.native
  def map(
  ...
  /**
    ...
    */
  def reverse(): Uint16Array = js.native
  ...
  val toStringTag: dom.std.stdStrings.Uint16Array = js.native
