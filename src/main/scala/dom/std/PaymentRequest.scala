...
import dom.std.stdStrings.paymentmethodchange
import dom.std.stdStrings.shippingaddresschange
import dom.std.stdStrings.shippingoptionchange
...
trait PaymentRequest
  ...
  var onpaymentmethodchange: (js.ThisFunction1[/* this */ this.type, /* ev */ Event, js.Any]) | Null = js.native
