...
object RTCError {
  ...
  def apply(
    ...
    __obj.updateDynamic("receivedAlert")(if (receivedAlert != null) receivedAlert.asInstanceOf[Double].asInstanceOf[js.Any] else null)
    __obj.updateDynamic("sctpCauseCode")(if (sctpCauseCode != null) sctpCauseCode.asInstanceOf[Double].asInstanceOf[js.Any] else null)
    __obj.updateDynamic("sdpLineNumber")(if (sdpLineNumber != null) sdpLineNumber.asInstanceOf[Double].asInstanceOf[js.Any] else null)
    __obj.updateDynamic("sentAlert")(if (sentAlert != null) sentAlert.asInstanceOf[Double].asInstanceOf[js.Any] else null)
