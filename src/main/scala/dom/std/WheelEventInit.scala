...
object WheelEventInit {
  ...
  def apply(
    ...
    if (!js.isUndefined(deltaMode)) __obj.updateDynamic("deltaMode")(deltaMode.asInstanceOf[js.Any])
    if (!js.isUndefined(deltaX)) __obj.updateDynamic("deltaX")(deltaX.asInstanceOf[js.Any])
    if (!js.isUndefined(deltaY)) __obj.updateDynamic("deltaY")(deltaY.asInstanceOf[js.Any])
    if (!js.isUndefined(deltaZ)) __obj.updateDynamic("deltaZ")(deltaZ.asInstanceOf[js.Any])
