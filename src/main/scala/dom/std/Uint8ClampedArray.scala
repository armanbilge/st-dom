...
trait Uint8ClampedArray
  ...
  /**
    ...
    * If thisArg is omitted, undefined is used as the this value.
    */
  def filter(predicate: js.Function3[/* value */ Double, /* index */ Double, /* array */ this.type, js.Any]): Uint8ClampedArray = js.native
  def filter(
    predicate: js.Function3[/* value */ Double, /* index */ Double, /* array */ this.type, js.Any],
    thisArg: js.Any
  ...
  def subarray(begin: Unit, end: Double): Uint8ClampedArray = js.native
  
  @JSName(js.Symbol.toStringTag)
  val toStringTag: dom.std.stdStrings.Uint8ClampedArray = js.native
