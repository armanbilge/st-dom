...
import dom.std.stdStrings.ANGLE_instanced_arrays
import dom.std.stdStrings.EXT_blend_minmax
import dom.std.stdStrings.EXT_frag_depth
import dom.std.stdStrings.EXT_sRGB
import dom.std.stdStrings.EXT_shader_texture_lod
import dom.std.stdStrings.EXT_texture_filter_anisotropic
import dom.std.stdStrings.OES_element_index_uint
import dom.std.stdStrings.OES_standard_derivatives
import dom.std.stdStrings.OES_texture_float
import dom.std.stdStrings.OES_texture_float_linear
import dom.std.stdStrings.OES_texture_half_float
import dom.std.stdStrings.OES_texture_half_float_linear
import dom.std.stdStrings.OES_vertex_array_object
import dom.std.stdStrings.WEBGL_color_buffer_float
import dom.std.stdStrings.WEBGL_compressed_texture_astc
import dom.std.stdStrings.WEBGL_compressed_texture_s3tc
import dom.std.stdStrings.WEBGL_compressed_texture_s3tc_srgb
import dom.std.stdStrings.WEBGL_debug_renderer_info
import dom.std.stdStrings.WEBGL_debug_shaders
import dom.std.stdStrings.WEBGL_depth_texture
import dom.std.stdStrings.WEBGL_draw_buffers
import dom.std.stdStrings.WEBGL_lose_context
