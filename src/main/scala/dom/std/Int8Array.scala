...
trait Int8Array
  ...
  /**
    ...
    * If thisArg is omitted, undefined is used as the this value.
    */
  def filter(predicate: js.Function3[/* value */ Double, /* index */ Double, /* array */ this.type, js.Any]): Int8Array = js.native
  def filter(
    predicate: js.Function3[/* value */ Double, /* index */ Double, /* array */ this.type, js.Any],
    thisArg: js.Any
  ): Int8Array = js.native
  ...
  /**
    ...
    * If thisArg is omitted, undefined is used as the this value.
    */
  def map(callbackfn: js.Function3[/* value */ Double, /* index */ Double, /* array */ this.type, Double]): Int8Array = js.native
  def map(
  ...
  def slice(start: Double): Int8Array = js.native
  def slice(start: Double, end: Double): Int8Array = js.native
  def slice(start: Unit, end: Double): Int8Array = js.native
  ...
  /**
    ...
    */
  def subarray(): Int8Array = js.native
  def subarray(begin: Double): Int8Array = js.native
  def subarray(begin: Double, end: Double): Int8Array = js.native
  def subarray(begin: Unit, end: Double): Int8Array = js.native
  
  @JSName(js.Symbol.toStringTag)
  val toStringTag: dom.std.stdStrings.Int8Array = js.native
