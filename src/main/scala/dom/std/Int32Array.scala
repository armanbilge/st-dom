...
trait Int32Array
  ...
  /**
    ...
    * If thisArg is omitted, undefined is used as the this value.
    */
  def filter(predicate: js.Function3[/* value */ Double, /* index */ Double, /* array */ this.type, js.Any]): Int32Array = js.native
  def filter(
    predicate: js.Function3[/* value */ Double, /* index */ Double, /* array */ this.type, js.Any],
    thisArg: js.Any
  ...
  /**
    ...
    */
  def reverse(): Int32Array = js.native
  ...
  def slice(start: Double, end: Double): Int32Array = js.native
  def slice(start: Unit, end: Double): Int32Array = js.native
  ...
  def subarray(begin: Unit, end: Double): Int32Array = js.native
  
  @JSName(js.Symbol.toStringTag)
  val toStringTag: dom.std.stdStrings.Int32Array = js.native
