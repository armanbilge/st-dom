...
trait Float64Array
  ...
  /**
    ...
    * If thisArg is omitted, undefined is used as the this value.
    */
  def filter(predicate: js.Function3[/* value */ Double, /* index */ Double, /* array */ this.type, js.Any]): Float64Array = js.native
  def filter(
    predicate: js.Function3[/* value */ Double, /* index */ Double, /* array */ this.type, js.Any],
    thisArg: js.Any
  ...
  /**
    ...
    */
  def reverse(): Float64Array = js.native
  ...
  def slice(start: Unit, end: Double): Float64Array = js.native
  ...
  def subarray(begin: Unit, end: Double): Float64Array = js.native
  
  @JSName(js.Symbol.toStringTag)
  val toStringTag: dom.std.stdStrings.Float64Array = js.native
